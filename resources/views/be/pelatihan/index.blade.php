                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('pelatihanbe.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="pelatihan" class="form-control" placeholder="Masukkan nama pelatihan"
                                required>
                        </div>
                        <div class="form-group">
                            <label>Lokasi</label>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <div class="btn-group">
                                    <a data-id="" href="{{ route('pelatihanbe.edit', $artikels->id) }}" class="btn btn-sm btn-info text-white show-modal mr-2"
                                        data-toggle="modal" data-target="#show_user">
                                        <i class="fas fa-pencil-alt" aria-hidden="true"></i>
                                    </a>
                                </div>
                                <div class="btn-group">
                                    <form action="{{ route('pelatihanbe.destroy', $artikels->id) }}" onsubmit="return confirm('Yakin ingin menghapus?')" method="POST">
                                        @csrf
                                        @method('DELETE')
